...
const Navbar = () => {
  ...
  <div>
    <Image src='/clashlogo.png' width={50} height={50} alt='fav' />
  </div>
  <div>
    <h3 className=' font-bold  text-neutral-950'>LEGEND BASES</h3>
  </div>
</div>
        ...
        <div className={
          ...
          <div>
            <div className='flex w-full items-center justify-between'>
              <Link href='/'><div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
  <div>
    <Image src='/clashlogo.png' width={50} height={50} alt='fav' />
  </div>
  <div>
    <h3 className='text-neutral-950 pt-2 font-bold'>LEGEND BASES</h3>
  </div>
</div>
</Link>
